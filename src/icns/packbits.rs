...
//!
//! Ported verbatim from `createicns.c` (`RleEncodeChannel`):
//! control bytes in `0x00..=0x7F` mean "the next n+1 bytes are literals" (1..=128);
//! control bytes in `0x80..=0xFF` mean "the next byte repeats n-125 times" (3..=130).
